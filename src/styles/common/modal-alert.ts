...
const modalAlertContainer: SxStyle = {
  ...
  width: { xs: '95%', sm: '450px' }, minHeight: '394px',
  background: 'white', borderRadius: '6px', padding: '24px',
};
const modalAlertLogo: SxStyle = { width: '180px', height: '180px', objectFit: 'cover', mb: '8px' };
const modalAlertContent: SxStyle = { width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px' };
...
export const modalAlertStyle = {
  modalAlert, modalAlertContainer, modalAlertLogo,
  modalAlertContent, modalAlertTitle, modalAlertDesc, modalAlertButton,
};
